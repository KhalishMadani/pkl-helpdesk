    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <li><a href="<?php echo base_url();?>C_tiket/permintaanbaru"><b>Permintaan Baru</b></a></li>

            <li><a style="color:white">(<?php echo $user['Nama_User'];?>) <span class="label label-success">Online</span></a>
            </li>
