    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
         ...
         <li><a href="<?php echo base_url();?>C_tiket/print_permintaan2" onclick="printContent('print')"><img src="<?php echo base_url()?>assets/images/printer.png" width="23px;" height="24px;"><b> Print</b></a></li>
 ...
 <!--                               Trouble Ticket  <br>
    ...
    echo $data_permintaan["Jenis_Permintaan"];} ?>
            ...
            <tr>
                ...
                <?php 
                if (!is_null($data_permintaan)) {
                    echo $data_permintaan["ulasan_implementasi"];} ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <?php 
                if (!is_null($data_permintaan)) {
                    echo $data_permintaan["Penilaian_pengerjaan"];} ?>
                </td>
            </tr>
            <tr>
                <td>
